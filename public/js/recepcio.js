$(function () {
  ...
  function oltozofoglalasUgyfelSzures(tomb,esemeny){
    ...
    if(tomb.length===0){
      ...
      apiVegpont = "/api/OltozoFoglalasFelvitel";
      let szoveg = {
